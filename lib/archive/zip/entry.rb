...
module Archive; class Zip
  ...
  module Entry
    ...
    # the entry.
    def self.parse(io, ignore_check_flags = 0)
      ...
      # same.
      compare_file_records(lfr, cfr, ignore_check_flags)
    ...
    def self.compare_file_records(lfr, cfr, ignore_check_flags = 1)
      ...
      if lfr.general_purpose_flags != cfr.general_purpose_flags && ignore_check_flags.to_i == 0 then
